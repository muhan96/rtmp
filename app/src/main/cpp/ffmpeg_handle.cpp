...
//定义日志宏变量
#define logw(content)   __android_log_write(ANDROID_LOG_WARN,"ftc",content)
#define loge(content)   __android_log_write(ANDROID_LOG_ERROR,"ftc",content)
#define logd(content)   __android_log_write(ANDROID_LOG_DEBUG,"ftc",content)
